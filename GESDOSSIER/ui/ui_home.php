                                                    ...
                                                    <div class="row g-gs">
                                                        ...
                                                        <div class="col-sm-6 col-md-4 col-xxl-3">
                                                            <div class="fake-class">
                                                                ...
                                                                <ul class="link-list is-compact pb-0">
                                                                    <li><a href="post-list.html"><em
                                                                                class="icon ni ni-edit-fill"></em><span>35
                                                                                Posts</span></a></li>
                                                                    <li><a href="page-list.html"><em
                                                                                class="icon ni ni-files"></em><span>21
                                                                                Pages</span></a></li>
                                                                    <li><a href="comments.html"><em
                                                                                class="icon ni ni-comments"></em><span>18
                                                                                Comments</span></a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row g-gs align-center">
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <div class="form-control-wrap"><label
                                                                            class="form-label"
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-control-wrap"><label class="form-label"
                                                                        for="content">Content</label><textarea
                                                ...
                                                <div class="nk-tb-list is-compact">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        <div class="nk-tb-col"><span
                                                                class="tb-sub"><span>/</span></span></div>
                                                        <div class="nk-tb-col text-end"><span
                                                                class="tb-sub tb-amount"><span>2,879</span></span></div>
                                                    </div>
                                                    <div class="nk-tb-item">
                                                        <div class="nk-tb-col"><span
                                                                class="tb-sub"><span>/subscription/index.html</span></span>
                                                        </div>
                                                        <div class="nk-tb-col text-end"><span
                                                                class="tb-sub tb-amount"><span>2,094</span></span></div>
                                                    </div>
                                                    <div class="nk-tb-item">
                                                        <div class="nk-tb-col"><span
                                                                class="tb-sub"><span>/general/index.html</span></span>
                                                        </div>
                                                        <div class="nk-tb-col text-end"><span
                                                                class="tb-sub tb-amount"><span>1,634</span></span></div>
                                                    </div>
                                                    <div class="nk-tb-item">
                                                        <div class="nk-tb-col"><span
                                                                class="tb-sub"><span>/crypto/index.html</span></span>
                                                        </div>
                                                        <div class="nk-tb-col text-end"><span
                                                                class="tb-sub tb-amount"><span>1,497</span></span></div>
                                                    </div>
                                                    <div class="nk-tb-item">
                                                        <div class="nk-tb-col"><span
                                                                class="tb-sub"><span>/invest/index.html</span></span>
                                                        </div>
                                                        <div class="nk-tb-col text-end"><span
                                                                class="tb-sub tb-amount"><span>1,349</span></span></div>
                                                    </div>
                                                    <div class="nk-tb-item">
                                                        <div class="nk-tb-col"><span
                                                                class="tb-sub"><span>/subscription/profile.html</span></span>
                                                        </div>
                                                        <div class="nk-tb-col text-end"><span
                                                                class="tb-sub tb-amount"><span>984</span></span></div>
                                                    </div>
                                                    <div class="nk-tb-item">
                                                        <div class="nk-tb-col"><span
                                                                class="tb-sub"><span>/general/index-crypto.html</span></span>
                                                        </div>
                                                        <div class="nk-tb-col text-end"><span
                                                                class="tb-sub tb-amount"><span>879</span></span></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <ul class="nk-activity">
                                                    <li class="nk-activity-item">
                                                        ...
                                                        <div class="nk-activity-data">
                                                            <div class="label">Keith Jensen posted a comment.</div><span
                                                    ...
                                                    <li class="nk-activity-item">
                                                        ...
                                                        <div class="nk-activity-data">
                                                            <div class="label">Stephanie edited his post.</div><span
                                                                class="time">2 hours ago</span>
                                                        </div>
                                                    </li>
                                                    <li class="nk-activity-item">
                                                        ...
                                                        <div class="nk-activity-data">
                                                            <div class="label">Timothy Moreno add a new post.</div><span
                                                                class="time">2 hours ago</span>
                                                        </div>
                                                    </li>
                                                </ul>
