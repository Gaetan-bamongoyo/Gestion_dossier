                                                        ...
                                                        <div class="nk-file-info">
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-xs">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li><a href="#equipe-new" data-bs-toggle="modal">
                                                        ...
                                                        <div class="nk-file-info">
                                                            <div class="nk-file-title">
                                                                <div class="nk-file-icon"><a class="nk-file-icon-link"
                                                                        href="personnel.php?id=<?php echo $row['id_equipe']?>"><span class="nk-file-icon-type"><svg
                                                                ...
                                                                <div class="nk-file-name">
                                                                    <div class="nk-file-name-text"><a href="#"
                                                                            class="title"><?php echo $row['designation_equipe']; ?></a>
