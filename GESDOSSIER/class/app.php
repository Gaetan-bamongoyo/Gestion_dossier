...
class App
 {
    ...
    public function __construct( $db_name = "bd_personnel", $db_user = "root", $db_pass = "", $db_host = 'localhost' )
    // public function __construct( $db_name = "c1commissionnaire_db", $db_user = "c1_siwa", $db_pass = "m!2pTuPGp6", $db_host = 'localhost' )
    {
    ...
    public function rowCount($rqt, $attribut = [])
    {
        $querry = $this->getPDO()->prepare($rqt);
        $querry->execute($attribut);
