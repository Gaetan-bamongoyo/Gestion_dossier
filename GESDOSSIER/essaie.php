...
<!-- Mirrored from dashlite.net/demo3/apps/files.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Apr 2022 08:16:18 GMT -->
<!-- Added by HTTrack -->
...
<body class="nk-body npc-apps apps-only has-apps-sidebar npc-apps-files">
    <div class="nk-app-root">
        <div class="nk-apps-sidebar is-theme">
            <div class="nk-apps-brand"><a href="../index.html" class="logo-link"><img class="logo-light logo-img"
            ...
            <div class="nk-sidebar-element">
                <div class="nk-sidebar-body">
                    <div class="nk-sidebar-content" data-simplebar>
                        <div class="nk-sidebar-menu">
                            <ul class="nk-menu apps-menu">
                                <li class="nk-menu-item"><a href="../cms/index.html" class="nk-menu-link"
                                        title="CMS Panel"><span class="nk-menu-icon"><em
                                                class="icon ni ni-template"></em></span></a></li>
                                <li class="nk-menu-hr"></li>
                                <li class="nk-menu-item"><a href="../index.html" class="nk-menu-link"
                                        title="Analytics Dashboard"><span class="nk-menu-icon"><em
                                                class="icon ni ni-dashboard"></em></span></a></li>
                                <li class="nk-menu-item"><a href="../index-sales.html" class="nk-menu-link"
                                        title="Sales Dashboard"><span class="nk-menu-icon"><em
                                                class="icon ni ni-speed"></em></span></a></li>
                                <li class="nk-menu-item"><a href="../index-crypto.html" class="nk-menu-link"
                                        title="Crypto Dashboard"><span class="nk-menu-icon"><em
                                                class="icon ni ni-bitcoin-cash"></em></span></a></li>
                                <li class="nk-menu-item"><a href="../index-invest.html" class="nk-menu-link"
                                        title="Invest Dashboard"><span class="nk-menu-icon"><em
                                                class="icon ni ni-invest"></em></span></a></li>
                                <li class="nk-menu-hr"></li>
                                <li class="nk-menu-item"><a href="mailbox.html" class="nk-menu-link"
                                        title="Mailbox"><span class="nk-menu-icon"><em
                                                class="icon ni ni-inbox"></em></span></a></li>
                                <li class="nk-menu-item"><a href="messages.html" class="nk-menu-link"
                                ...
                                <li class="nk-menu-item"><a href="chats.html" class="nk-menu-link" title="Chats"><span
                                            class="nk-menu-icon"><em class="icon ni ni-chat-circle"></em></span></a>
                                </li>
                                <li class="nk-menu-item"><a href="calendar.html" class="nk-menu-link"
                                        title="Calendar"><span class="nk-menu-icon"><em
                                                class="icon ni ni-calendar"></em></span></a></li>
                                <li class="nk-menu-item"><a href="kanban.html" class="nk-menu-link"><span
                                            class="nk-menu-icon"><em class="icon ni ni-template"></em></span></a></li>
                                <li class="nk-menu-hr"></li>
                                <li class="nk-menu-item"><a href="../components.html" class="nk-menu-link"
                    ...
                    <div class="nk-sidebar-profile nk-sidebar-profile-fixed dropdown"><a href="#"
                            data-bs-toggle="dropdown" data-offset="50,-60">
                        ...
                        <div class="nk-header-wrap">
                            ...
                            <div class="nk-header-tools">
                                <ul class="nk-quick-nav">
                                    <li class="dropdown hide-mb-sm"><a href="#" data-bs-toggle="modal"
                                            data-bs-target="#region" class="nk-quick-nav-icon"><em
                                    ...
                                    <li class="dropdown chats-dropdown hide-mb-sm"><a href="#"
                                        ...
                                        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end">
                                            ...
                                            <div class="dropdown-body">
                                                <ul class="chat-list">
                                                    <li class="chat-item"><a class="chat-link" href="chats.html">
                                            ...
                                            <div class="dropdown-foot center"><a href="../chats.html">View All</a></div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="dropdown list-apps-dropdown d-lg-none"><a href="#"
                                        ...
                                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                                            <div class="dropdown-body">
                                                <ul class="list-apps">
                                                    <li><a href="../index.html"><span class="list-apps-media"><em
                                                    ...
                                                    <li><a href="../components.html"><span class="list-apps-media"><em
                            ...
                            <li class="nk-menu-item has-sub"><a href="#" class="nk-menu-link nk-menu-toggle"><span
                                ...
                                <ul class="nk-menu-sub">
                                    ...
                                    <li class="nk-menu-item"><a href="../components/forms/input-group.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Input Group</span></a></li>
                                    <li class="nk-menu-item"><a href="../components/forms/form-upload.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Form Upload</span></a></li>
                                    ...
                                    <li class="nk-menu-item"><a href="../components/forms/nouislider.html"
                                            class="nk-menu-link"><span class="nk-menu-text">noUiSlider</span></a></li>
                            ...
                            <li class="nk-menu-item has-sub"><a href="#" class="nk-menu-link nk-menu-toggle"><span
                                ...
                                <ul class="nk-menu-sub">
                                    <li class="nk-menu-item"><a href="../components/widgets/cards.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Card Widgets</span></a></li>
                                    ...
                                    <li class="nk-menu-item"><a href="../components/widgets/ratings.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Ratings Widget</span><span
                            ...
                            <li class="nk-menu-item has-sub"><a href="#" class="nk-menu-link nk-menu-toggle"><span
                                ...
                                <ul class="nk-menu-sub">
                                    <li class="nk-menu-item"><a href="../components/misc/slick-sliders.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Slick Slider</span></a></li>
                                    ...
                                    <li class="nk-menu-item"><a href="../components/misc/dual-listbox.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Dual Listbox</span></a></li>
                                    <li class="nk-menu-item"><a href="../components/misc/dragula.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Dragula</span><span
                                                class="nk-menu-badge">New</span></a></li>
                                    <li class="nk-menu-item"><a href="../components/misc/map.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Google Map</span><span
                                                class="nk-menu-badge">New</span></a></li>
                                </ul>
                            </li>
                                    ...
                                    <div class="nk-fmg-aside-wrap">
                                        <div class="nk-fmg-aside-top">
                                            <ul class="nk-fmg-menu">
                                                <li><a class="nk-fmg-menu-item" href="file-manager.html"><em
                                                            class="icon ni ni-home-alt"></em><span
                                                            class="nk-fmg-menu-text">Home</span></a></li>
                                                <li class="active"><a class="nk-fmg-menu-item" href="files.html"><em
                                                            class="icon ni ni-file-docs"></em><span
                                                            class="nk-fmg-menu-text">Files</span></a></li>
                                                <li><a class="nk-fmg-menu-item" href="starred.html"><em
                                                            class="icon ni ni-star"></em><span
                                                            class="nk-fmg-menu-text">Starred</span></a></li>
                                                <li><a class="nk-fmg-menu-item" href="shared.html"><em
                                                            class="icon ni ni-share-alt"></em><span
                                                            class="nk-fmg-menu-text">Shared</span></a></li>
                                                <li><a class="nk-fmg-menu-item" href="recovery.html"><em
                                                            class="icon ni ni-trash-alt"></em><span
                                                            class="nk-fmg-menu-text">Recovery</span></a></li>
                                                <li><a class="nk-fmg-menu-item" href="settings.html"><em
                                            ...
                                            <ul class="nk-block-tools g-3">
                                                <li>
                                                    <div class="dropdown"><a href="#" class="btn btn-light"
                                                            data-bs-toggle="dropdown"><em class="icon ni ni-plus"></em>
                                                            <span>Create</span></a>
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <ul class="link-list-opt no-bdr">
                                        ...
                                        <div class="nk-block-head nk-block-head-sm">
                                            <div class="nk-block-between position-relative">
                                                    ...
                                                    <ul class="nk-block-tools g-1">
                                                        ...
                                                        <li class="d-lg-none">
                                                            <div class="dropdown"><a href="#"
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li><a href="files.html"><em
                                                                                    class="icon ni ni-view-grid3-wd"></em><span>Grid
                                                                                    View</span></a></li>
                                                                        <li><a href="files-group-view.html"><em
                                                                                    class="icon ni ni-view-group-wd"></em><span>Group
                                                                                    View</span></a></li>
                                                                        <li><a href="files-list-view.html"><em
                                                                                    class="icon ni ni-view-row-wd"></em><span>List
                                                                                    View</span></a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="nk-block-head-content d-none d-lg-block">
                                                    <ul class="nk-block-tools g-3">
                                                        <li><a href="files.html" class="nk-switch-icon active"><em
                                                        ...
                                                        <li><a href="files-list-view.html" class="nk-switch-icon"><em
                                                                ...
                                                                <div class="nk-file-icon"><a class="nk-file-icon-link"
                                                                        href="#"><span class="nk-file-icon-type"><svg
                                                                                ...
                                                                                <rect x="27" y="43" width="14"
                                                                                    height="2" rx="1" ry="1"
                                                                                    style="fill:#fff" />
                                                                                <rect x="27" y="47" width="8" height="2"
                                                                                    rx="1" ry="1" style="fill:#fff" />
                                                                            </svg></span></a></div>
                                                                <div class="nk-file-name">
                                                                    <div class="nk-file-name-text"><a href="#"
                                                    ...
                                                    <div class="nk-file-item nk-file">
                                                        <div class="nk-file-info">
                                                            <div class="nk-file-title">
                                                                ...
                                                                <div class="nk-file-name">
                                                                    <div class="nk-file-name-text"><a href="#"
                                                                            class="title">2019 Presentation.ppt</a>
                                                                        <div class="asterisk"><a href="#"><em
                                                                                    class="asterisk-off icon ni ni-star"></em><em
                                                                                    class="asterisk-on icon ni ni-star-fill"></em></a>
                                                                        </div>
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header align-center">
                    ...
                    </div><a href="#" class="close" data-bs-dismiss="modal"><em class="icon ni ni-cross-sm"></em></a>
                </div>
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header align-center border-bottom-0">
                    <h5 class="modal-title">Copy item to...</h5><a href="#" class="close" data-bs-dismiss="modal"><em
                            class="icon ni ni-cross-sm"></em></a>
                </div>
                        ...
                        <div class="g">
                            <ul class="btn-toolbar g-3">
                                <li><a href="#" data-bs-dismiss="modal"
                                        class="btn btn-outline-light btn-white">Cancel</a></li>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="file-move">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header align-center border-bottom-0">
                    <h5 class="modal-title">Move item to...</h5><a href="#" class="close" data-bs-dismiss="modal"><em
                            class="icon ni ni-cross-sm"></em></a>
                </div>
                <div class="modal-body pt-0 mt-n2">
                    <ul class="breadcrumb breadcrumb-alt breadcrumb-xs breadcrumb-arrow mb-1">
                        ...
                        <div class="nk-file-details-row">
                            ...
                            <div class="nk-file-details-col">
                                <div class="user-avatar-group">
                                    <div class="user-avatar xs"><img src="../images/avatar/b-sm.jpg" alt=""></div>
                ...
                <div class="modal-body modal-body-md">
                    ...
                    <div class="nk-upload-list">
                        ...
                        <div class="nk-upload-item">
                            <div class="nk-upload-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72">
                                    <g>
                            ...
                            <div class="nk-upload-info">
                                <div class="nk-upload-title"><span class="title">dashlite-latest-version.zip</span>
                                </div>
                                <div class="nk-upload-size">25.49 MB</div>
                            </div>
                            <div class="nk-upload-action"><a href="#" class="btn btn-icon btn-trigger"
                                    data-bs-dismiss="modal"><em class="icon ni ni-trash"></em></a></div>
                        </div>
                        <div class="nk-upload-item">
                            <div class="nk-upload-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72">
                                    <g>
    ...
    <div class="nk-demo-panel nk-demo-panel-2x toggle-slide toggle-slide-right" data-content="demoUC"
        ...
        <div class="nk-demo-list" data-simplebar>
            ...
            <div class="nk-demo-item"><a href="../cms/index.html">
            ...
            <div class="nk-demo-item"><a href="file-manager.html">
            ...
            <div class="nk-demo-item"><a href="messages.html">
            ...
            <div class="nk-demo-item"><a href="mailbox.html">
            ...
            <div class="nk-demo-item"><a href="chats.html">
        ...
        <div class="nk-opt-panel" data-simplebar>
            ...
            <div class="nk-opt-set nk-opt-set-aside-apps">
                ...
                <div class="nk-opt-list col-4x">
                    ...
                    <div class="nk-opt-item" data-key="appside" data-update="is-theme"><span
    ...
    <script src="assets/js/apps/file-manager6e0e.js?ver=3.0.0"></script>
</body>
<!-- Mirrored from dashlite.net/demo3/apps/files.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Apr 2022 08:16:19 GMT -->
